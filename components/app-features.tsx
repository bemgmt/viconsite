        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, idx) => {
            ...
            return (
              <details
                key={idx}
                className="group flex flex-col gap-6 p-8 bg-primary/5 border border-primary/20 rounded-lg hover:border-accent/50 transition-colors"
              >
                <summary className="list-none cursor-pointer">
                  <div className="flex items-start justify-between gap-6">
                    ...
                    <ChevronDown className="text-accent flex-shrink-0 transition-transform duration-300 group-open:rotate-180" size={24} />
                  </div>
                </summary>
